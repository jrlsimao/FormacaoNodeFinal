...
export class RotasMotorista {
    ...
    constructor(serverApp: Express.Application){
        ...
        this.expressApp.delete('/deleteMotoristas', controladorAuth.verificaLogin.bind(controladorAuth),this.localController.DeleteMotorista.bind(this.localController));
